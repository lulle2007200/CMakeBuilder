...
class CMakePresets:
    ...
    def __init__(self, path_input: Union[str, Path, CMakeRoot]):
        """
    ...
    def get_preset_by_name(self, preset_type: str, name: str) -> Union[Dict[str, Any], None]:
        """
    ...
    def find_preset(self, name: str) -> Union[Dict[str, Any], None]:
        """
    ...
    def find_related_presets(self, configure_preset_name: str, preset_type: Union[str, None] = None) -> Union[Dict[str, List[Dict[str, Any]]], None]:
        """
