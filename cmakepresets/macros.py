...
from typing import Dict, Union, Mapping, Tuple, Match
...
class MacroResolver:
    ...
    def resolve_in_preset(
        ...
        file_paths: Union[Mapping[str, Union[str, Path]], None] = None,
    ) -> Dict[str, Any]:
        """
    ...
    def _replace_macro(self, match: Match[str], context: Dict[str, Any]) -> str:
    ...
    def _replace_env(self, match: Match[str], context: Dict[str, Any]) -> str:
    ...
    def _replace_penv(self, match: Match[str], context: Dict[str, Any]) -> str:
        env_name: str = match.group(1)
...
def create_resolver(path_input: Union[str, Path] = "") -> MacroResolver:
    """
...
def resolve_macros_in_preset(
    preset: Dict[str, Any],
    path_input: Union[str, Path, CMakeRoot],
    file_paths: Union[Mapping[str, Union[str, Path]], None] = None,
